...
def parse_options():
    ...
    parser.add_argument('-i', '--input', help='The dir path of input', type=str, default='./dataset/novul_bin')
    parser.add_argument('-o', '--output', help='The dir path of output', type=str, default='./dataset/novul_output_pdg')
...
def joern_export(bin, outdir, repr):
    ...
    if repr == 'pdg':
        os.system('sh joern-export $bin'+ " --repr " + "pdg" + ' -o $out')
        try:
